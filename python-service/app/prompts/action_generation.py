...
Réponds UNIQUEMENT avec un tableau JSON valide contenant les actions que tu proposes, sous forme de chaînes de caractères en français, sans aucun texte avant ou après, sans balises markdown (pas de ```json).
